...
<#-- Custom VIVO individual profile page template with Scite badges -->
...
<#-- Add Scite badge JavaScript -->
${scripts.add('<script async type="application/javascript" src="https://cdn.scite.ai/badge/scite-badge-latest.min.js"></script>')}
